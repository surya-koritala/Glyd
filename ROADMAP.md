...
## Where it stands (v0.6.0, 2026-09-20)
...
than zstd -19; the cold level (unreleased): 1.5–2× fewer than zstd -19 at
1.2 MB/s per core. Versions with
...
The cold level (`--cold`, unreleased): context mixing at 1.2–1.3 MB/s
