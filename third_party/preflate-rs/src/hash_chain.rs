...
pub trait HashChain {
    ...
    /// Starts the table's positions at `pos`: for a chain that begins
    /// in the middle of a stream. Only before anything is added.
    fn rebase(&mut self, pos: u32);
